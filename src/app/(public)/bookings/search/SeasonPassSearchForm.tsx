    ...
    <>
      <form action={formAction} className="mt-7 rounded-2xl border border-green-100 bg-white p-7 shadow-sm md:p-8">
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <label className="block text-lg font-semibold text-green-900 md:text-xl">
            เบอร์โทรศัพท์
            <input name="customerPhone" inputMode="tel" maxLength={20} required className="mt-2 w-full rounded-lg border border-slate-300 px-4 py-3.5 text-lg font-normal outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 md:text-xl" placeholder="เบอร์ที่ใช้สมัคร" />
          </label>
        </div>
        <p className="mt-4 text-base text-slate-500 md:text-lg">กรอกเบอร์โทรศัพท์ที่ใช้สมัครเพื่อค้นหาบัตรรายปี และใส่ชื่อผู้สมัครเพิ่มเติมได้เพื่อให้ผลลัพธ์แม่นยำขึ้น</p>
